...
class ApparelNaturalbeautybasic(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/naturalbeautybasic'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        areas = soup.find_all('ul', 'shop_info')
        for area in areas:
...
_store['address']
                ...
                _store['tel_no'] = store.find('p', 'tel').find('a').text
                _store['open_hours'] = ''
                _store['gla'] = ''
...
if __name__ == '__main__':
    ApparelNaturalbeautybasic(True)
