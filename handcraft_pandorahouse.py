...
class HandcraftPandorahouse(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/handcraft/pandorahouse'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('tr', {'class': 'stores-list-item'})
...
_store['address']
        ...
        _store['open_hours'] = soup.find('th', text='営業時間').find_next('td').text.split('※')[0]
        _store['gla'] = ''
