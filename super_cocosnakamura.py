...
class SuperCocosnakamura(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/cocosnakamura'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('div', 'shoptitle')
        for store in store_lists:
            link = domain + store.parent.find('a')['href']
