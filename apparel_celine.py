...
class ApparelCeline(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/celine'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        for store in store_lists['response']['entities']:
            ...
            store = store['profile']
            _store = dict()
            _store['url_store'] = "REDACTED URL"+ store_url
            try:
              _store['store_name'] = store['c_nom_LocalBRFRCNSAndTJPSP']
            except:
              _store['store_name'] = store['c_storeLongNameJDE']
_store['address'] = store['address']['postalCode'] + ' ' + store['c_adresse_LocalBRFRCNSAndTJPSP']
