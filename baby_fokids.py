...
class BabyFokids(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/baby/fokids'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('div', 'store-search')
...
_store['address'] = soup.find('th', text='住所：').find_next_sibling('td').text.replace('\u3000', '').replace('MAP', '')
