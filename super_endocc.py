...
class SuperEndocc(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/endocc'.replace("/", "_")
        self.content = list()
    ...
    """
        ...
        content = list()
        store_lists = soup.find_all('strong', {'class': 'fsize16'})
    ...
    """
        ...
        _store['store_name'] = soup.find('h1', {'class': 'pagetitle'}).text.replace('\u3000', '')
