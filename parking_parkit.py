...
class ParkingParkit(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/parking/parkit'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('td', 'th_sell03')
...
_store['address'] = soup.find('th', text='駐車場住所').find_next_sibling('td').text
