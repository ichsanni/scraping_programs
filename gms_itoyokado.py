...
class GmsItoyokado(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/gms/itoyokado'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('h4')[1:]
  ...
  """
        ...
        _store['store_name'] = soup.find('span', 'LocationName-brand').text
...
_store['address']
        ...
        _store['open_hours'] = soup.find_all('div', 'c-hours')[-1].text.replace('\n', '').replace('\t', '').replace('\r', '').replace('\u3000', '')
        _store['tel_no'] = soup.find_all('div', 'Phone')[-1].text.replace('\n', '').replace('\t', '').replace('\r', '').replace('\u3000', '')
        _store['gla'] = ''
