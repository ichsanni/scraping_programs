...
class SuperOzeki(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/ozeki'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('div', {'class': 'col'})
...
_store['address'] = details[0].text.split('※')[0].split('Google')[0].replace('\n', '')
