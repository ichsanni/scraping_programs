...
class HandcraftHobbyrahobbyre(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/handcraft/hobbyrahobbyre'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.select('div.p-shoplistList__item a')
...
_store['address']
        ...
        try: _store['open_hours'] = soup.find('th', text='営業時間').find_next_sibling('td').text
