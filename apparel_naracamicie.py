...
class ApparelNaracamicie(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/naracamicie'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        for area in areas:
            ...
            for store in store_lists:
                ...
                _store['store_name'] = store.find('p', 'name').text
_store['address'] = store.find('p', 'address').text

                _store['lat'], _store['lon'] = '', ''
                _store['tel_no'] = store.find('p', 'phone').text
                _store['open_hours'] = ''
                _store['gla'] = ''
