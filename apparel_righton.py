...
class ApparelRighton(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/righton'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        store_lists = soup.find('ul', {'class': 'maplist'}).find_all('li')[1:11]
        for store in store_lists:
            ...
            if 'detail' in link:
                ...
                time.sleep(0.5)
        try:
            next_button = "REDACTED URL"+ soup.find('span', {'class': 'nex'}).find('a')['href']
  ...
  """
        ...
        _store['store_name'] = soup.find('h1', 'tit_bor').text
