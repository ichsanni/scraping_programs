...
class BicycleCycly(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/bicycle/cycly'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('span', 'glyphicon-list-alt')
  ...
  """
        ...
        _store['store_name'] = soup.find('div', text=re.compile('店舗名')).find_next_sibling('div').text.strip()
_store['address'] = soup.find('div', text=re.compile('住所')).find_next_sibling('div').text.strip()
        # maps = soup.find('div', 'mb').find('iframe')['src']
...
_store['address']
        ...
        _store['tel_no'] = soup.find('div', text=re.compile('Tel')).find_next_sibling('div').text.strip()
        _store['open_hours'] = ''
        _store['gla'] = ''
