...
class ContactAce(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/contact/ace'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find('div', 'searchListArea').find_all('a')
...
_store['address'] = soup.find('td', {'itemprop': 'address'}).text.replace('Google mapで見る', '').replace('\n', '').replace('\r', '').replace(' ', '')
