...
class ApparelKutsushitaya(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/kutsushitaya'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        store_lists = soup.find('section', 'result').find('div', 'wrap').find_all('a')
        ...
        try:
            next_page = "REDACTED URL"+ soup.find('li', 'next').find('a')['href']
  ...
  """
        ...
        _store['store_name'] = soup.find('span', 'shop_name').text
