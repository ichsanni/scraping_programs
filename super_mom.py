...
class SuperMom(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/mom'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('a', {'class': 'link_box red'})
  ...
  """
        ...
        _store['store_name'] = soup.find('div', {'class': 'store_title'}).text.replace('\n', '').replace('\t', '')
