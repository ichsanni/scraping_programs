...
class RepairMamanoreform(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/repair/mamanoreform'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        store_lists = soup.find_all('div', 'listShopBlc')
...
_store['address'] = store.find('dt', text='住所').find_next_sibling('dd').text
            ...
            _store['open_hours'] = store.find('dt', text='営業時間').find_next_sibling('dd').text.replace('コロナ禍での営業時間について', '').replace('▶▶▶', '')
            _store['gla'] = ''
