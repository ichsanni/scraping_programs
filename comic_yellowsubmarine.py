...
class ComicYellowsubmarine(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/comic/yellowsubmarine'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find('section', {'id': 'store'}).find_all('a')
  ...
  """
        ...
        _store['store_name'] = soup.find('h2').texttry:
