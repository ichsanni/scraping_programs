...
class SuperOdawara100(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/odawara100'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('div', 'storeData')
...
_store['address'] = soup.find('li', 'address').text
        maps_link = "REDACTED URL"+ 
_store['address']

        _store['lat'], _store['lon'] = '', ''

        _store['tel_no'] = soup.find('li', 'tel').text
        _store['open_hours'] = soup.find('li', 'open').text
        _store['gla'] = ''
