...
class BuffetFestagarden(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/buffet/festagarden'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        for store in store_lists:
            if store['brand']['id'] != 102: continue
            _store = dict()
...
_store['address'] = store['address']
            ...
            _store['open_hours'] = store['businessHour']
            _store['gla'] = ''
