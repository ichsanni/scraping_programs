...
class PcIosys(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/pc/iosys'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        areas = soup.find_all('div', 'shopsearch')
        for area in areas:
  ...
  """
        ...
        _store['store_name'] = soup.find('div', 'shop-top').text.replace('\n', '')
_store['address'] = soup.find('th', text='住所').find_next_sibling('td').text
        maps_link = soup.find('div', 'gmap').find('iframe')['src']
