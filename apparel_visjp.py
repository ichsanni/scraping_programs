...
class ApparelVisjp(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/visjp'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('p', 'detail')
  ...
  """
        ...
        _store['store_name'] = soup.find('dt', 'tit').text
...
_store['address']
        ...
        _store['open_hours'] = soup.find('ul', 'time').get_text(separator='/', strip=True)
        _store['gla'] = ''
