...
class ShoesStep(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/shoes/step'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('div', 'shoplist-name')
  ...
  """
        ...
        _store['store_name'] = soup.find('div', 'shoppage-name').text
_store['address'] = soup.find('dt', text='郵便番号').find_next_sibling('dd').text + soup.find('dt', text='住所').find_next_sibling('dd').text

        _store['lat'], _store['lon'] = '', ''
        _store['tel_no'] = soup.find('dt', text='電話番号').find_next_sibling('dd').text
        _store['open_hours'] = soup.find('dt', text=re.compile('営業時間')).find_next_sibling('dd').text
        _store['gla'] = ''
