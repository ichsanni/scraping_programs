...
class SuperSatohweb(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/satohweb'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('a', 'p-shopCard')
...
_store['address'] = soup.find('li', 'p-shopInfo--address').text

        _store['lat'], _store['lon'] = '', ''
        _store['tel_no'] = soup.find('li', 'p-shopInfo--tel').text
        _store['open_hours'] = soup.find('li', 'p-shopInfo--time').text
        _store['gla'] = ''
