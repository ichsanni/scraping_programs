...
class CoinlaundryDolphin(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/coinlaundry/dolphin'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        for area in areas:
            ...
            for store in store_lists:
                store_link = area_link.replace('index.html', '') + store.find('a')['href']
