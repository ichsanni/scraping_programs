...
class BentoChickendish(CleaningData):
    def __init__(self, from_main=False):
        self.file_name = '_bento_chickendish.py'.replace('/', '_').replace('.py', '')
    ...
    def get_page(self, url):
        ...
        chickendish_logo = soup.find('div', {'id': 'nav4'})
        assert 'チキン・デイッシュ' in chickendish_logo.text, "Div telah berubah, kemungkinan toko update, cek websitenya atau cek rokesuma"

        store_lists = chickendish_logo.find_next_sibling('div').find_all('div', 'pp-infobox-wrap')
