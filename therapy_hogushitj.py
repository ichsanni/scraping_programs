...
class TherapyHogushitj(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/therapy/hogushitj'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('tr', 'touchbtn')
        for store in store_lists:
            link = store['data-href']
  ...
  """
        ...
        _store['store_name'] = soup.find('h1', 'shop_name').text.strip()
