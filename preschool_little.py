...
class PreschoolLittle(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/preschool/little'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('div', 'one_room')
...
_store['address'] = soup.find('p', 'address_txt').text.replace('\u3000', ' ').strip()
