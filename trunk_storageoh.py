...
class TrunkStorageoh(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/trunk/storageoh'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        _store['store_name'] = soup.find_all('h1')[-1].text.strip()try:
            
_store['address'] = soup.find('dt', text='住所').find_next_sibling('dd').text.strip()
