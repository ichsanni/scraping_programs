...
class SuperMarudai(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/marudai'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find('div', 'posts').find_all('a', 'title')
...
_store['address'] = soup.find('dt', text='住所：').find_next('dd').text.split('Google')[0]
        maps_link = soup.find('dt', text='住所：').find_next('dd').find('a')['href']
