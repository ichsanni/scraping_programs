...
class KimonoEwhayifu(CleaningData):
  def __init__(self, from_main=False):
    self.file_name = '_kimono_ewhayifu.py'.replace('/', '_').replace('.py', '')
  ...
  def get_page(self, url):
    ...
    store_lists = soup.find_all('a', 'shop-link')
  ...
  def get_data(self, url):
    ...
    _store['store_name'] = soup.find('h1', 'line03').text
