...
class JukuAllup(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/juku/allup'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find('ul', 'school-list').find_all('li')
...
_store['address'] = soup.find('th', text='住所').find_next_sibling('td').text
        ...
        _store['tel_no'] = soup.find('span', 'phone').text
        _store['open_hours'] = ''
        _store['gla'] = ''
