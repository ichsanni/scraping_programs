...
class SuperEllena(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/ellena'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        _store['store_name'] = soup.find('div', 'sub_title').text.replace('\n', '')
_store['address'] = soup.find('td', text='住所').find_next('td').text.replace('\n', '')

        _store['lat'], _store['lon'] = '', ''
        _store['tel_no'] = soup.find('td', text='電話番号').find_next('td').text.replace('\n', '')
        _store['open_hours'] = soup.find('td', text='営業時間').find_next('td').text.replace('\n', '')
        _store['gla'] = ''
