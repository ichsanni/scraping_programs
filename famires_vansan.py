...
class FamiresVansan(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/famires/vansan'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('li', 'tenpo_detail')
  ...
  """
        ...
        _store['store_name'] = soup.select('span.sbar-ja')[0].text
