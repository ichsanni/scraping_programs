...
class PcPipopark(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/pc/pipopark'.replace("/", "_")
        self.content = list()
        self.asession = None
  ...
  """
        ...
        domain = "REDACTED URL"
        content = list()
        store_lists = soup.find_all('li', 'shop-li')
  ...
  """
        ...
        _store['store_name'] = soup.find('span', {'id': 'shop_title'}).text
_store['address'] = soup.find('div', {'id': 'shop_address'}).text
        maps_link = "REDACTED URL"+ 
_store['address']

        _store['lat'], _store['lon'] = '', ''

        _store['tel_no'] = soup.find('span', {'id': 'shop_tel'}).text
        _store['open_hours'] = soup.find('div', {'id': 'shop_open'}).text
        _store['gla'] = ''
