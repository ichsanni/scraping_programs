...
class SuperDomy(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/domy'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find('div', {'class': 'shopBox'}).find_all('a')
  ...
  """
        ...
        _store['store_name'] = soup.find('h3').text.split('詳細')[0]
_store['address'] = soup.find('dt', text='所在地').find_next('dd').text

        _store['lat'], _store['lon'] = '', ''
        _store['tel_no'] = soup.find('dt', text='TEL').find_next('dd').text
