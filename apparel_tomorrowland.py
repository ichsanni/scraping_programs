...
class ApparelTomorrowland(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/apparel/tomorrowland'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        urls = ["REDACTED URL" 'https://www.tomorrowland.co.jp/shoplocator/outlet/']
        for url in urls:
