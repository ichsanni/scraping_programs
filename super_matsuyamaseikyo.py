...
class SuperMatsuyamaseikyo(CleaningData):

    def __init__(self, from_main=False):
        self.from_main = from_main
 
        self.file_name = '/super/matsuyamaseikyo'.replace("/", "_")
        self.content = list()
  ...
  """
        ...
        content = list()
        store_lists = soup.find_all('div', 'btn')
  ...
  """
        ...
        _store['store_name'] = soup.find('h2', 'shopname').text
