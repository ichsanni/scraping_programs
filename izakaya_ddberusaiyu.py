...
class IzakayaDdberusaiyu(CleaningData):
    def __init__(self, from_main=False):
        self.file_name = '_izakaya_ddberusaiyu.py'.replace('/', '_').replace('.py', '')
...
_store['address'] = soup.find('dt', text='住所 / 地図').find_next_sibling('dd').text
        ...
        try: _store['取扱'] = '[総座席数]' + soup.find('dt', text='総座席数').find_next_sibling('dd').text.replace('\n', '') # Handling
        except AttributeError: _store['取扱'] = ''
        _store['備考'] = '' # Remarks
